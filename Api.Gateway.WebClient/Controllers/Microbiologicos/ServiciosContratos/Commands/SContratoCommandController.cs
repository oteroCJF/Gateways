...
namespace Api.Gateway.WebClient.Controllers.Microbiologicos.ServiciosContratos.Commands
{
    ...
    {
        private readonly ICSContratoMicrobiologicosProxy _scontrato;


        public SContratoCommandController(ICSContratoMicrobiologicosProxy scontrato)
        {

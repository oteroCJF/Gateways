...
namespace Api.Gateway.WebClient.Controllers.Microbiologicos.EntregablesContrato.Queries
{
    [ApiController]
    ...
    public class EContratoCommandController : ControllerBase
    {
        ...
        public EContratoCommandController(IQEContratoMicrobiologicosProxy entregables)
        {

...
namespace Api.Gateway.WebClient.Controllers.Agua.ServiciosContratos.Commands
{
    ...
    {
        private readonly ICSContratoAguaProxy _scontrato;


        public SContratoCommandController(ICSContratoAguaProxy scontrato)
        {

...
namespace Api.Gateway.WebClient.Controllers.Agua.CFDIs.Procedure
{
    public interface ICFDIAguaProcedure
    {
        HistorialMFCreateCommand GetObservacionesHCM(HistorialMFCreateCommand historial, CFDIDto factura);
    }

    public class CFDIAguaProcedure : ICFDIAguaProcedure
    {
        public CFDIAguaProcedure()
        {
        }

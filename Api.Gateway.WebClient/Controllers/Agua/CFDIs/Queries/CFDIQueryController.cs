...
namespace Api.Gateway.WebClient.Controllers.Agua.CFDIs.Queries
{
    ...
    public class CFDIQueryController : ControllerBase
    {
        ...
        private readonly IQCFDIAguaProxy _cfdi;
        private readonly IEstatusFacturaProxy _estatusFacturas;

        public CFDIQueryController(IUsuarioProxy usuarios, IInmuebleProxy inmuebles, IMesProxy mes, IQRepositorioAguaProxy repositorios, 
                                   IQCFDIAguaProxy cfdi, IEstatusFacturaProxy estatusFacturas)
        {
            _usuarios = usuarios;

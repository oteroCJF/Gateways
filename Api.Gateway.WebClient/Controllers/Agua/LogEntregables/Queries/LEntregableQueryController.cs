...
namespace Api.Gateway.WebClient.Controllers.Agua.LogEntregables.Queries
{
    ...
    {
        private readonly IQLEntregableAguaProxy _logs;
        private readonly IEstatusEntregableProxy _estatus;
        private readonly ICTEntregableProxy _centregables;
        private readonly IUsuarioProxy _usuarios;

        public LEntregableQueryController(IQLEntregableAguaProxy logs, IEstatusEntregableProxy estatus, IUsuarioProxy usuarios,

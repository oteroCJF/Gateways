...
namespace Api.Gateway.WebClient.Controllers.Agua.Dashboard
{

    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    [ApiController]
    [Route("agua/dfinancieros")]
    public class DFinancierosController : ControllerBase
    {
        ...
        public DFinancierosController(IMesProxy meses, ICTServicioProxy servicios, IQRepositorioAguaProxy repositorios, IInmuebleProxy inmuebles, 
                                      IEstatusFacturaProxy estatusf, IEstatusCedulaProxy estatusc, IQCFDIAguaProxy facturas, 
                                      IQCedulaAguaProxy cedula)
        {
            _meses = meses;

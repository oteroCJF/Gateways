...
namespace Api.Gateway.WebClient.Controllers.Agua.Dashboard
{
    ...
    public class DashboardController : ControllerBase
    {
        ...
        public DashboardController(IMesProxy meses, ICTServicioProxy servicios, IQCedulaAguaProxy cedula, IQRepositorioAguaProxy repositorios, 
                                   IInmuebleProxy inmuebles, IEstatusCedulaProxy estatusc, IQCFDIAguaProxy facturas)
        {
            _meses = meses;

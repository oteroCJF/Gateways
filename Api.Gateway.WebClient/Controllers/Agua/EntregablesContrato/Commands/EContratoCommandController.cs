...
namespace Api.Gateway.WebClient.Controllers.Agua.EntregablesContrato.Commands
{
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    [Route("agua/entregablesContrato")]
    public class EContratoCommandController : ControllerBase
    {
        private readonly ICEContratoAguaProxy _entregables;

        public EContratoCommandController(ICEContratoAguaProxy entregables)
        {

...
namespace Api.Gateway.WebClient.Controllers.Agua.Firmantes.Queries
{
    ...
    public class FirmanteQueryController : ControllerBase
    {
        ...
        public FirmanteQueryController(IQFirmanteAguaProxy firmantes, IUsuarioProxy usuarios, IInmuebleProxy inmuebles)
        {

...
namespace Api.Gateway.WebClient.Controllers.Agua.Entregables.Procedures.Commands
{
    public interface ICEntregableAguaProcedure
    {
    ...
    public class CEntregableAguaProcedure : ICEntregableAguaProcedure
    {
        ...
        public CEntregableAguaProcedure(IMesProxy meses, ICTEntregableProxy ctentregables, ICEntregableAguaProxy entregablesCommand, 
                                              IQEntregableAguaProxy entregablesQuery, IEstatusEntregableProxy estatus)
        {
            _meses = meses;

...
namespace Api.Gateway.WebClient.Controllers.Agua.Oficios.Queries
{
    ...
    public class OficioController : ControllerBase
    {
        ...
        private readonly IQOficioAguaProxy _oficios;
        private readonly IQCFDIAguaProxy _facturas;
        private readonly ICFDIAguaProcedure _mpcfdi;

        public OficioController(IMesProxy meses, ICTServicioProxy servicios, IInmuebleProxy inmuebles, IQCedulaAguaProxy cedula, 
                                IEstatusCedulaProxy estatusc, IEstatusOficioProxy estatuso, IEstatusFacturaProxy estatusf, 
                                IQRepositorioAguaProxy repositorios, IQOficioAguaProxy oficios, IQCFDIAguaProxy facturas,
                                ICFDIAguaProcedure mpcfdi)
        {
            _meses = meses;
        ...
        private async Task<CedulaAguaDto> GetCedulaId(int id, int inmueble)
        {
            var facturacion = await _repositorios.GetRepositorioByIdAsync(id);

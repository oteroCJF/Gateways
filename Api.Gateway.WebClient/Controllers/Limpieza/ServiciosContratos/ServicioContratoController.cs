...
namespace Api.Gateway.WebClient.Controllers.Limpieza.ServiciosContratos
{
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    [ApiController]
    [Route("limpieza/servicioContrato")]
    public class ServicioContratoController : ControllerBase
    {
        private readonly ILServicioContratoProxy _scontrato;

        public ServicioContratoController(ILServicioContratoProxy scontrato)
        {

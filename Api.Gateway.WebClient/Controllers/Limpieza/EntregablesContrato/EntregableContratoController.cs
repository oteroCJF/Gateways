...
namespace Api.Gateway.WebClient.Controllers.Limpieza.EntregablesContrato
{
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    [Route("limpieza/entregablesContrato")]
    public class EntregableContratoController : ControllerBase
    {
        private readonly ILEContratoProxy _entregables;
        private readonly IHostingEnvironment _environment;

        public EntregableContratoController(ILEContratoProxy entregables, IHostingEnvironment environment)
        {

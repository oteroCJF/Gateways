...
namespace Api.Gateway.WebClient.Controllers.Convencional.ServiciosContratos.Commands
{
    ...
    {
        private readonly ICSContratoConvencionalProxy _scontrato;


        public SContratoCommandController(ICSContratoConvencionalProxy scontrato)
        {

...
namespace Api.Gateway.WebClient.Controllers.Transporte.EntregablesContrato.Queries
{
    [ApiController]
    ...
    public class EContratoCommandController : ControllerBase
    {
        ...
        public EContratoCommandController(IQEContratoTransporteProxy entregables)
        {

...
namespace Api.Gateway.WebClient.Controllers.Transporte.Repositorios.Queries
{
    ...
    public class RepositorioController : ControllerBase
    {
        ...
        private readonly IQContratoTransporteProxy _contrato;
        private readonly IUsuarioProxy _usuarios;
        private readonly IInmuebleProxy _inmuebles;
        private readonly IMesProxy _mes;

        public RepositorioController(IQRepositorioTransporteProxy repositorios, IQCFDITransporteProxy facturas, IQContratoTransporteProxy contrato, 

...
namespace Api.Gateway.WebClient.Controllers.Transporte.Dashboard
{
    ...
    public class DFinancierosController : ControllerBase
    {
        ...
        public DFinancierosController(IMesProxy meses, ICTServicioProxy servicios, IQRepositorioTransporteProxy repositorios, IInmuebleProxy inmuebles, 
                                      IEstatusFacturaProxy estatusf, IEstatusCedulaProxy estatusc, IQCFDITransporteProxy facturas, 
                                      IQCedulaTransporteProxy cedula)
        {
            _meses = meses;

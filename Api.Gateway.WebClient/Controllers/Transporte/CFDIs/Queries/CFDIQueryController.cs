...
namespace Api.Gateway.WebClient.Controllers.Transporte.CFDIs.Queries
{
    ...
    public class CFDIQueryController : ControllerBase
    {
        ...
        private readonly IQCFDITransporteProxy _cfdi;
        private readonly IEstatusFacturaProxy _estatusFacturas;

        public CFDIQueryController(IUsuarioProxy usuarios, IInmuebleProxy inmuebles, IMesProxy mes, IQRepositorioTransporteProxy repositorios, 
                                   IQCFDITransporteProxy cfdi, IEstatusFacturaProxy estatusFacturas)
        {
            _usuarios = usuarios;

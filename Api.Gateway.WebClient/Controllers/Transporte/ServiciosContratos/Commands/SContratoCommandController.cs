...
namespace Api.Gateway.WebClient.Controllers.Transporte.ServiciosContratos.Commands
{
    ...
    {
        private readonly ICSContratoTransporteProxy _scontrato;


        public SContratoCommandController(ICSContratoTransporteProxy scontrato)
        {

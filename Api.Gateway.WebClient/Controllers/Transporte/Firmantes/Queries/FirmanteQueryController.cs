...
namespace Api.Gateway.WebClient.Controllers.Transporte.Firmantes.Queries
{
    ...
    {
        private readonly IQFirmanteTransporteProxy _firmantes;
        private readonly IUsuarioProxy _usuarios;
        private readonly IInmuebleProxy _inmuebles;

        public FirmanteQueryController(IQFirmanteTransporteProxy firmantes, IUsuarioProxy usuarios, IInmuebleProxy inmuebles)
        {

...
namespace Api.Gateway.WebClient.Controllers.Transporte.Contratos.Queries
{
    ...
    public class ContratoTransporteController : ControllerBase
    {
        ...
        private readonly IQConvenioTransporteProxy _convenios;
        private readonly IQSContratoTransporteProxy _scontrato;
        private readonly IQEContratoTransporteProxy _entregables;

        public ContratoTransporteController(IUsuarioProxy usuarios, IQContratoTransporteProxy contratos, IQConvenioTransporteProxy convenios, 
                                          IQSContratoTransporteProxy scontrato, IQEContratoTransporteProxy entregables, ICTEntregableProxy centregables, 

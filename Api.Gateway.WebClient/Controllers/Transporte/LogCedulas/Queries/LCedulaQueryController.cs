...
namespace Api.Gateway.WebClient.Controllers.Transporte.LogCedulas.Queries
{
    ...
    public class LCedulaQueryController : ControllerBase
    {
        ...
        public LCedulaQueryController(IQLCedulaTransporteProxy logs, IEstatusCedulaProxy estatus, IUsuarioProxy usuarios)
        {
            _logs = logs;
            _estatus = estatus;
            _usuarios = usuarios;

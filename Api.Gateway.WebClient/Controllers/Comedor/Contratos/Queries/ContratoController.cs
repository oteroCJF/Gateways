...
namespace Api.Gateway.WebClient.Controllers.Comedor.Contratos.Queries
{
    ...
    public class ContratoComedorController : ControllerBase
    {
        ...
        private readonly IQContratoComedorProxy _contratos;
        private readonly IQConvenioComedorProxy _convenios;
        private readonly IQSContratoComedorProxy _scontrato;
        private readonly IQEContratoComedorProxy _entregables;

        public ContratoComedorController(IUsuarioProxy usuarios, IQContratoComedorProxy contratos, IQConvenioComedorProxy convenios, 
                                          IQSContratoComedorProxy scontrato, IQEContratoComedorProxy entregables, ICTEntregableProxy centregables, 

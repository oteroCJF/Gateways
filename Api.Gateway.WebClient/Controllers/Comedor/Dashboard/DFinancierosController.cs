...
namespace Api.Gateway.WebClient.Controllers.Comedor.Dashboard
{
    ...
    public class DFinancierosController : ControllerBase
    {
        ...
        public DFinancierosController(IMesProxy meses, ICTServicioProxy servicios, IQRepositorioComedorProxy repositorios, IInmuebleProxy inmuebles,
                                      IEstatusFacturaProxy estatusf, IEstatusCedulaProxy estatusc, IQCFDIComedorProxy facturas,
                                      IQCedulaComedorProxy cedula)
        {
            _meses = meses;

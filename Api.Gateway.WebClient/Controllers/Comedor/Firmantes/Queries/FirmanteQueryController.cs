...
namespace Api.Gateway.WebClient.Controllers.Comedor.Firmantes.Queries
{
    ...
    public class FirmanteQueryController : ControllerBase
    {
        ...
        public FirmanteQueryController(IQFirmanteComedorProxy firmantes, IUsuarioProxy usuarios, IInmuebleProxy inmuebles)
        {

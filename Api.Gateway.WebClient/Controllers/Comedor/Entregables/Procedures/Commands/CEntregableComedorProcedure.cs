...
namespace Api.Gateway.WebClient.Controllers.Comedor.Entregables.Procedures.Commands
{
    public interface ICEntregableComedorProcedure
    {
    ...
    public class CEntregableComedorProcedure : ICEntregableComedorProcedure
    {
        ...
        public CEntregableComedorProcedure(IMesProxy meses, ICTEntregableProxy ctentregables, ICEntregableComedorProxy entregablesCommand, 
                                              IQEntregableComedorProxy entregablesQuery, IEstatusEntregableProxy estatus)
        {
            _meses = meses;

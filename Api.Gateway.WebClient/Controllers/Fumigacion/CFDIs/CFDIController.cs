...
namespace Api.Gateway.WebClient.Controllers.Fumigacion.Facturas
{
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    [ApiController]
    [Route("fumigacion/cfdi")]
    public class CFDIController : ControllerBase
    {
        ...
        public CFDIController(IFRepositorioProxy facturacion, IFCFDIProxy facturas, IFContratoProxy contrato, IUsuarioProxy usuarios, 

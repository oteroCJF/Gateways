...
namespace Api.Gateway.WebClient.Controllers.Fumigacion.Firmantes
{
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    [ApiController]
    [Route("fumigacion/firmantes")]
    public class FirmanteController : ControllerBase
    {
        ...
        public FirmanteController(IFFirmanteProxy firmantes, IUsuarioProxy usuarios, IInmuebleProxy inmuebles)
        {

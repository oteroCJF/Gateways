...
namespace Api.Gateway.WebClient.Controllers.BMuebles.EntregablesContrato.Queries
{
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    [Route("bmuebles/entregablesContrato")]
    public class EContratoQueryController : ControllerBase
    {
        private readonly IBMEContratoProxy _entregables;
        private readonly IHostingEnvironment _environment;

        public EContratoQueryController(IBMEContratoProxy entregables, IHostingEnvironment environment)
        {

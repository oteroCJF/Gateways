...
namespace Api.Gateway.WebClient.Controllers.Mensajeria.Oficios.Commands
{
    ...
    {
        private readonly ICOficioMensajeriaProxy _oficios;

        public OficioCommandController(ICOficioMensajeriaProxy oficios)
        {
            _oficios = oficios;
        }

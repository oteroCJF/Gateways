...
namespace Api.Gateway.WebClient.Controllers.Mensajeria.Entregables.Procedures.Commands
{
    public interface ICEntregableMensajeriaProcedure
    {
    ...
    public class CEntregableMensajeriaProcedure : ICEntregableMensajeriaProcedure
    {
        ...
        public CEntregableMensajeriaProcedure(IMesProxy meses, ICTEntregableProxy ctentregables, ICEntregableMensajeriaProxy entregablesCommand, 
                                              IQEntregableMensajeriaProxy entregablesQuery, IEstatusEntregableProxy estatus)
        {
            _meses = meses;

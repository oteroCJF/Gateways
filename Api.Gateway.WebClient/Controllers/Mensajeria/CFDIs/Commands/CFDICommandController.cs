...
namespace Api.Gateway.WebClient.Controllers.Mensajeria.CFDIs.Commands
{
    ...
    {
        private readonly ICCFDIMensajeriaProxy _cfdi;
        private readonly ICFDIMensajeriaProcedure _cfdiProcedure;

        public CFDICommandController(ICCFDIMensajeriaProxy cfdi, ICFDIMensajeriaProcedure cfdiProcedure)
        {
            _cfdi = cfdi;

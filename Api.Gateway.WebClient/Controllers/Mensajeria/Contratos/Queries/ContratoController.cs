...
namespace Api.Gateway.WebClient.Controllers.Mensajeria.Contratos.Queries
{
    ...
    public class ContratoLimpiezaController : ControllerBase
    {
        ...
        public ContratoLimpiezaController(IUsuarioProxy usuarios, IQContratoMensajeriaProxy contratos, IQConvenioMensajeriaProxy convenios, 
                                          IQSContratoMensajeriaProxy scontrato, IQEContratoMensajeriaProxy entregables, ICTEntregableProxy centregables, 

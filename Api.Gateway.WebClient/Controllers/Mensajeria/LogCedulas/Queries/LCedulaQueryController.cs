...
namespace Api.Gateway.WebClient.Controllers.Mensajeria.LogCedulas.Queries
{
    ...
    public class LCedulaQueryController : ControllerBase
    {
        ...
        public LCedulaQueryController(IQLCedulaMensajeriaProxy logs, IEstatusCedulaProxy estatus, IUsuarioProxy usuarios)
        {
            _logs = logs;
            _estatus = estatus;
            _usuarios = usuarios;

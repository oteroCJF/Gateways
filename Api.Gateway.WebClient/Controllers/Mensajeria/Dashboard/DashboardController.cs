...
namespace Api.Gateway.WebClient.Controllers.Mensajeria.Dashboard
{
    ...
    public class DashboardController : ControllerBase
    {
        ...
        public DashboardController(IMesProxy meses, ICTServicioProxy servicios, IQCedulaMensajeriaProxy cedula, IQRepositorioMensajeriaProxy repositorios, 
                                   IInmuebleProxy inmuebles, IEstatusCedulaProxy estatusc, IQCFDIMensajeriaProxy facturas)
        {
            _meses = meses;

...
namespace Api.Gateway.WebClient.Controllers.Mensajeria.EntregablesContrato.Queries
{
    [ApiController]
    ...
    public class EContratoCommandController : ControllerBase
    {
        ...
        public EContratoCommandController(IQEContratoMensajeriaProxy entregables)
        {

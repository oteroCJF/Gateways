...
namespace Api.Gateway.WebClient.Controllers.Mensajeria.Firmantes.Queries
{
    ...
    public class FirmanteQueryController : ControllerBase
    {
        ...
        public FirmanteQueryController(IQFirmanteMensajeriaProxy firmantes, IUsuarioProxy usuarios, IInmuebleProxy inmuebles)
        {

...
namespace Api.Gateway.WebClient.Controllers.Celular.Convenios.Commands
{
    ...
    {
        private readonly ICConvenioCelularProxy _convenios;

        public ConvenioController(ICConvenioCelularProxy convenios)
        {

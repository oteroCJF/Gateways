...
namespace Api.Gateway.WebClient.Controllers.Celular.ServiciosContratos.Commands
{
    ...
    {
        private readonly ICSContratoCelularProxy _scontrato;


        public SContratoCommandController(ICSContratoCelularProxy scontrato)
        {

...
namespace Api.Gateway.WebClient.Controllers.Celular.Contratos.Queries
{
    ...
    public class ContratoCelularController : ControllerBase
    {
        ...
        private readonly IQContratoCelularProxy _contratos;
        ...
        public ContratoCelularController(IUsuarioProxy usuarios, IQContratoCelularProxy contratos, IQConvenioCelularProxy convenios, 
                                          IQSContratoCelularProxy scontrato, IQEContratoCelularProxy entregables, ICTEntregableProxy centregables, 

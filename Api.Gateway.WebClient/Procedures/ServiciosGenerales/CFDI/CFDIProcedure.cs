...
namespace Api.Gateway.WebClient.Procedures.ServiciosGenerales.CFDI
{
    public interface ICFDIProcedure
    {
        HistorialMFCreateCommand GetObservacionesHCM(HistorialMFCreateCommand historial, CFDIDto factura);
    }

    public class MCFDIProcedure : ICFDIProcedure
    {
        public MCFDIProcedure()
        {
        }

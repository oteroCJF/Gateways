...
{
    public interface IFEntregablesProcedure
    {
        Task<string> DescargarEntregables(DEntregablesCommand request);
    }

    public class FEntregablesProcedure : IFEntregablesProcedure
    {
        ...
        public FEntregablesProcedure(IFCedulaProxy cedulas, IFEntregableProxy entregables, IMesProxy meses, ICTEntregableProxy ctentregables,

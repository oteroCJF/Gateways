...
namespace Api.Gateway.Proxies.Agua.ServiciosContrato.Commands
{
    public interface ICSContratoAguaProxy
    {
    ...
    public class CSContratoAguaProxy : ICSContratoAguaProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public CSContratoAguaProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<ServicioContratoDto> CreateServicioContrato([FromBody] ServicioContratoCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.AguaUrl}api/agua/servicioContrato/createSContrato", content);
        ...
        public async Task<ServicioContratoDto> UpdateServicioContrato([FromBody] ServicioContratoUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.AguaUrl}api/agua/servicioContrato/updateSContrato", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteServicioContrato([FromBody] ServicioContratoDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.AguaUrl}api/agua/servicioContrato/deleteSContrato", content);
            request.EnsureSuccessStatusCode();

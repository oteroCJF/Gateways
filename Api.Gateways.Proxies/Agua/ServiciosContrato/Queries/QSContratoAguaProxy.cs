...
namespace Api.Gateway.Proxies.Agua.ServiciosContrato.Queries
{
    ...
    public class QSContratoAguaProxy : IQSContratoAguaProxy
    {
        ...
        public QSContratoAguaProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.AguaUrl}api/agua/servicioContrato/getServiciosContrato/{contrato}");

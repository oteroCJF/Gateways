...
namespace Api.Gateway.Proxies.Agua.Convenios.Commands
{
    ...
    public class CConvenioAguaProxy : ICConvenioAguaProxy
    {
        ...
        public CConvenioAguaProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> CreateConvenio([FromForm] ConvenioCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.AguaUrl}api/agua/convenios/createConvenio", content);
        ...
        public async Task<int> UpdateConvenio([FromForm] ConvenioUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.AguaUrl}api/agua/convenios/updateConvenio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteConvenio([FromForm] ConvenioDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.AguaUrl}api/agua/convenios/deleteConvenio", content);
            request.EnsureSuccessStatusCode();

...
namespace Api.Gateway.Proxies.Agua.EntregablesContrato.Commands
{
    ...
    public class CEContratoAguaProxy : ICEContratoAguaProxy
    {
        ...
        public CEContratoAguaProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.AguaUrl}api/agua/entregablesContratacion/updateEntregableContratacion", formContent);

...
namespace Api.Gateway.Proxies.Agua.EntregablesContrato.Queries
{
    public interface IQEContratoAguaProxy
    {
    ...
    public class QEContratoAguaProxy : IQEContratoAguaProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public QEContratoAguaProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.AguaUrl}api/agua/entregablesContratacion/getEntregablesByContrato/{contrato}");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.AguaUrl}api/agua/entregablesContratacion/getEntregablesByContratoConvenio/{contrato}/{convenio}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.AguaUrl}api/agua/entregablesContratacion/getEntregableById/{entregable}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.AguaUrl}api/agua/entregablesContratacion/visualizarEntregableCont/{contrato}/{tipoEntregable}/{archivo}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.AguaUrl}api/agua/entregablesContratacion/visualizarEntregableConv/{contrato}/{convenio}/{tipoEntregable}/{archivo}");
            request.EnsureSuccessStatusCode();

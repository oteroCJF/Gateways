...
namespace Api.Gateway.Proxies.Agua.Incidencias.Queries
{
    ...
    public class QIncidenciaAguaProxy : IQIncidenciaAguaProxy
    {
        ...
        public QIncidenciaAguaProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.AguaUrl}api/agua/incidenciasCedula/getIncidenciasByCedulaAndPregunta/{cedula}/{pregunta}");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.AguaUrl}api/agua/incidenciasCedula/getIncidenciasByCedula/{cedula}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.AguaUrl}api/agua/incidenciasCedula/getIncidenciaByCedulaAndPregunta/{cedula}/{pregunta}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.AguaUrl}api/agua/incidenciasCedula/getConfiguracionIncidencias");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.AguaUrl}api/agua/incidenciasCedula/getConfiguracionIncidenciasByPregunta/{pregunta}/{respuesta}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.AguaUrl}api/agua/incidenciasCedula/visualizarActas/{anio}/{mes}/{folio}/{tipo}/{tipoArchivo}/{archivo}");
            request.EnsureSuccessStatusCode();

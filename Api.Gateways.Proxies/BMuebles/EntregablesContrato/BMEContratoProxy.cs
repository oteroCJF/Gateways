...
namespace Api.Gateway.Proxies.BMuebles.EntregablesContrato
{
    public interface IBMEContratoProxy
    {
    ...
    public class BMEContratoProxy : IBMEContratoProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public BMEContratoProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.BMueblesUrl}api/bmuebles/entregablesContratacion/getEntregablesByContrato/{contrato}");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.BMueblesUrl}api/bmuebles/entregablesContratacion/getEntregablesByContratoConvenio/{contrato}/{convenio}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.BMueblesUrl}api/bmuebles/entregablesContratacion/getEntregableById/{entregable}");
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.BMueblesUrl}api/bmuebles/entregablesContratacion/updateEntregableContratacion", formContent);
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.BMueblesUrl}api/bmuebles/entregablesContratacion/visualizarEntregableCont/{contrato}/{tipoEntregable}/{archivo}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.BMueblesUrl}api/bmuebles/entregablesContratacion/visualizarEntregableConv/{contrato}/{convenio}/{tipoEntregable}/{archivo}");
            request.EnsureSuccessStatusCode();

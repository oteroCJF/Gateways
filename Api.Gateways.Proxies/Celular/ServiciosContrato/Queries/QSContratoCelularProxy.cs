...
namespace Api.Gateway.Proxies.Celular.ServiciosContrato.Queries
{
    ...
    public class QSContratoCelularProxy : IQSContratoCelularProxy
    {
        ...
        public QSContratoCelularProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.CelularUrl}api/celular/servicioContrato/getServiciosContrato/{contrato}");

...
namespace Api.Gateway.Proxies.Celular.Convenios.Queries
{
    ...
    public class QConvenioCelularProxy : IQConvenioCelularProxy
    {
        ...
        public QConvenioCelularProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.CelularUrl}api/celular/convenios/getConveniosByContrato/{contrato}");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.CelularUrl}api/celular/convenios/getConvenioById/{convenio}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.CelularUrl}api/celular/convenios/getRubrosByConvenio/{convenio}");
            request.EnsureSuccessStatusCode();

...
namespace Api.Gateway.Proxies.Mensajeria.Repositorios.Commands
{
    ...
    public class CRepositorioMensajeriaProxy : ICRepositorioMensajeriaProxy
    {
        ...
        public CRepositorioMensajeriaProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> CreateRepositorio([FromBody] RepositorioCreateCommand repositorio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/repositorios/createRepositorio", content);

...
namespace Api.Gateway.Proxies.Mensajeria.Firmantes.Commands
{
    ...
    public class CFirmanteMensajeriaProxy : ICFirmanteMensajeriaProxy
    {
        ...
        public CFirmanteMensajeriaProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<FirmanteDto> CreateFirmantes([FromBody] FirmanteCreateCommand firmantes)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/firmantes/createFirmantes", content);
        ...
        public async Task<FirmanteDto> UpdateFirmantes([FromBody] FirmanteUpdateCommand firmantes)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/firmantes/updateFirmantes", content);
            request.EnsureSuccessStatusCode();

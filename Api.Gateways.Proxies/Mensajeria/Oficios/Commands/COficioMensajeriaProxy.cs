...
namespace Api.Gateway.Proxies.Mensajeria.Oficios.Commands
{
    public interface ICOficioMensajeriaProxy
    {
    ...
    public class COficioMensajeriaProxy : ICOficioMensajeriaProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public COficioMensajeriaProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<OficioDto> CreateOficio([FromForm] OficioCreateCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/oficios/createOficio", formContent);
        ...
        public async Task<List<DetalleOficioCreateCommand>> CreateDetalleOficio([FromBody] List<DetalleOficioCreateCommand> dtOficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/oficios/createDetalleOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<DetalleOficioDto> DeleteDetalleOficio([FromBody] DetalleOficioDeleteCommand dtOficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/oficios/deleteDetalleOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> CorregirOficio([FromBody] CorregirOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/oficios/corregirOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> EDGPPTOficio([FromBody] EDGPPTOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/oficios/enviarDGPPTOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> PagarOficio([FromBody] PagarOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/oficios/pagarOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> CancelarOficio([FromBody] CancelarOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/oficios/cancelarOficio", content);
            request.EnsureSuccessStatusCode();

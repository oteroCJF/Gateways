...
namespace Api.Gateway.Proxies.Mensajeria.Entregables.Commands
{
    public interface ICEntregableMensajeriaProxy
    {
    ...
    public class CEntregableMensajeriaProxy : ICEntregableMensajeriaProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public CEntregableMensajeriaProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<EntregableDto> CreateEntregable([FromBody] EntregableCreateCommand entregable)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/entregables/createEntregable", content);
        ...
        public async Task UpdateEntregable([FromForm] EntregableCommandUpdate entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/entregables/actualizarEntregable", formContent);
            request.EnsureSuccessStatusCode();
        }
        ...
        public async Task<EntregableDto> DeleteEntregable([FromBody] EntregableDeleteCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/entregables/deleteEntregable", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task AUpdateEntregable([FromForm] EEntregableUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/entregables/autorizarEntregable", content);
            request.EnsureSuccessStatusCode();
        }
        ...
        public async Task UpdateEntregableSR([FromBody] ESREntregableUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/entregables/updateEntregableSR", content);
            request.EnsureSuccessStatusCode();
        }
    }
}

...
namespace Api.Gateway.Proxies.Mensajeria.EntregablesContrato.Commands
{
    public interface ICEContratoMensajeriaProxy
    {
        Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand command);
    }
    public class CEContratoMensajeriaProxy : ICEContratoMensajeriaProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public CEContratoMensajeriaProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/entregablesContratacion/updateEntregableContratacion", formContent);

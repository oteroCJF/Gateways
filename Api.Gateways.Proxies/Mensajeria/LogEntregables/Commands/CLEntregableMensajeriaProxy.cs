...
namespace Api.Gateway.Proxies.Mensajeria.LogEntregables.Commands
{
    ...
    public class CLEntregableMensajeriaProxy : ICLEntregableMensajeriaProxy
    {
        ...
        public CLEntregableMensajeriaProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task CreateHistorial([FromBody] LogEntregableCreateCommand historial)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.MensajeriaUrl}api/mensajeria/logEntregables/createHistorial", content);

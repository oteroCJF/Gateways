...
namespace Api.Gateway.Proxies.Microbiologicos.ServiciosContrato.Commands
{
    ...
    public class CSContratoMicrobiologicosProxy : ICSContratoMicrobiologicosProxy
    {
        ...
        public CSContratoMicrobiologicosProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<ServicioContratoDto> CreateServicioContrato([FromBody] ServicioContratoCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.MicrobiologicosUrl}api/microbiologicos/servicioContrato/createSContrato", content);
        ...
        public async Task<ServicioContratoDto> UpdateServicioContrato([FromBody] ServicioContratoUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.MicrobiologicosUrl}api/microbiologicos/servicioContrato/updateSContrato", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteServicioContrato([FromBody] ServicioContratoDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.MicrobiologicosUrl}api/microbiologicos/servicioContrato/deleteSContrato", content);
            request.EnsureSuccessStatusCode();

...
namespace Api.Gateway.Proxies.Microbiologicos.ServiciosContrato.Queries
{
    ...
    public class QSContratoMicrobiologicosProxy : IQSContratoMicrobiologicosProxy
    {
        ...
        public QSContratoMicrobiologicosProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.MicrobiologicosUrl}api/microbiologicos/servicioContrato/getServiciosContrato/{contrato}");

...
namespace Api.Gateway.Proxies.Microbiologicos.Convenios.Queries
{
    ...
    public class QConvenioMicrobiologicosProxy : IQConvenioMicrobiologicosProxy
    {
        ...
        public QConvenioMicrobiologicosProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.MicrobiologicosUrl}api/microbiologicos/convenios/getConveniosByContrato/{contrato}");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.MicrobiologicosUrl}api/microbiologicos/convenios/getConvenioById/{convenio}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.MicrobiologicosUrl}api/microbiologicos/convenios/getRubrosByConvenio/{convenio}");
            request.EnsureSuccessStatusCode();

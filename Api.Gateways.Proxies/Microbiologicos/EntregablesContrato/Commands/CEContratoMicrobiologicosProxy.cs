...
namespace Api.Gateway.Proxies.Microbiologicos.EntregablesContrato.Commands
{
    public interface ICEContratoMicrobiologicosProxy
    {
        Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand command);
    }
    public class CEContratoMicrobiologicosProxy : ICEContratoMicrobiologicosProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public CEContratoMicrobiologicosProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.MicrobiologicosUrl}api/microbiologicos/entregablesContratacion/updateEntregableContratacion", formContent);

...
namespace Api.Gateway.Proxies.Comedor.Oficios
{
    ...
    public class COficioProxy : ICOficioProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public COficioProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.ComedorUrl}api/comedor/oficios");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.ComedorUrl}api/comedor/oficios/getOficiosByAnio/{anio}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.ComedorUrl}api/comedor/oficios/getOficioById/{id}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.ComedorUrl}api/comedor/oficios/getDetalleOficio/{oficio}");
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> CreateOficio([FromForm] OficioCreateCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.ComedorUrl}api/comedor/oficios/createOficio", formContent);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<List<DetalleOficioCreateCommand>> CreateDetalleOficio([FromBody] List<DetalleOficioCreateCommand> dtOficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.ComedorUrl}api/comedor/oficios/createDetalleOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<DetalleOficioDto> DeleteDetalleOficio([FromBody] DetalleOficioDeleteCommand dtOficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.ComedorUrl}api/comedor/oficios/deleteDetalleOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> CorregirOficio([FromBody] CorregirOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.ComedorUrl}api/comedor/oficios/corregirOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> EDGPPTOficio([FromBody] EDGPPTOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.ComedorUrl}api/comedor/oficios/enviarDGPPTOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> PagarOficio([FromBody] PagarOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.ComedorUrl}api/comedor/oficios/pagarOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> CancelarOficio([FromBody] CancelarOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.ComedorUrl}api/comedor/oficios/cancelarOficio", content);
            request.EnsureSuccessStatusCode();

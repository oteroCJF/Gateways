...
namespace Api.Gateway.Proxies.Comedor.LogCedula.Commands
{
    ...
    public class CLCedulaComedorProxy : ICLCedulaComedorProxy
    {
        ...
        public CLCedulaComedorProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task CreateHistorial([FromBody] LogCedulaCreateCommand historial)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.ComedorUrl}api/comedor/logCedulas/createHistorial", content);

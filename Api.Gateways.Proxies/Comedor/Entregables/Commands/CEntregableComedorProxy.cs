...
namespace Api.Gateway.Proxies.Comedor.Entregables.Commands
{
    ...
    public class CEntregableComedorProxy : ICEntregableComedorProxy
    {
        ...
        public CEntregableComedorProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<EntregableDto> CreateEntregable([FromBody] EntregableCreateCommand entregable)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.ComedorUrl}api/comedor/entregables/createEntregable", content);
        ...
        public async Task UpdateEntregable([FromForm] EntregableCommandUpdate entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.ComedorUrl}api/comedor/entregables/actualizarEntregable", formContent);
            request.EnsureSuccessStatusCode();
        }
        ...
        public async Task<EntregableDto> DeleteEntregable([FromBody] EntregableDeleteCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.ComedorUrl}api/comedor/entregables/deleteEntregable", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task AUpdateEntregable([FromForm] EEntregableUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.ComedorUrl}api/comedor/entregables/autorizarEntregable", content);
            request.EnsureSuccessStatusCode();
        }
        ...
        public async Task UpdateEntregableSR([FromBody] ESREntregableUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.ComedorUrl}api/comedor/entregables/updateEntregableSR", content);
            request.EnsureSuccessStatusCode();
        }
    }
}

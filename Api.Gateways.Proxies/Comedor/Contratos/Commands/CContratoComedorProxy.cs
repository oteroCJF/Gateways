...
namespace Api.Gateway.Proxies.Comedor.Contratos.Commands
{
    ...
    public class CContratoComedorProxy : ICContratoComedorProxy
    {
        ...
        public CContratoComedorProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> CreateContrato([FromForm] ContratoCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.ComedorUrl}api/comedor/contratos/createContrato", content);
        ...
        public async Task<int> UpdateContrato([FromForm] ContratoUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.ComedorUrl}api/comedor/contratos/updateContrato", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteContrato([FromForm] ContratoDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.ComedorUrl}api/comedor/contratos/deleteContrato", content);
            request.EnsureSuccessStatusCode();

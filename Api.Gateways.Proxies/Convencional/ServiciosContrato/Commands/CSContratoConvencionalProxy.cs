...
namespace Api.Gateway.Proxies.Convencional.ServiciosContrato.Commands
{
    ...
    public class CSContratoConvencionalProxy : ICSContratoConvencionalProxy
    {
        ...
        public CSContratoConvencionalProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<ServicioContratoDto> CreateServicioContrato([FromBody] ServicioContratoCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.ConvencionalUrl}api/convencional/servicioContrato/createSContrato", content);
        ...
        public async Task<ServicioContratoDto> UpdateServicioContrato([FromBody] ServicioContratoUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.ConvencionalUrl}api/convencional/servicioContrato/updateSContrato", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteServicioContrato([FromBody] ServicioContratoDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.ConvencionalUrl}api/convencional/servicioContrato/deleteSContrato", content);
            request.EnsureSuccessStatusCode();

...
namespace Api.Gateway.Proxies.Convencional.Contratos.Queries
{
    ...
    public class QContratoConvencionalProxy : IQContratoConvencionalProxy
    {
        ...
        public QContratoConvencionalProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.ConvencionalUrl}api/convencional/contratos/getContratos");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.ConvencionalUrl}api/convencional/contratos/getContratoById/{contrato}");
            request.EnsureSuccessStatusCode();

...
namespace Api.Gateway.Proxies.Convencional.EntregablesContrato.Commands
{
    public interface ICEContratoConvencionalProxy
    {
        Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand command);
    }
    public class CEContratoConvencionalProxy : ICEContratoConvencionalProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public CEContratoConvencionalProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.ConvencionalUrl}api/convencional/entregablesContratacion/updateEntregableContratacion", formContent);

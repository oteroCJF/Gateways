...
namespace Api.Gateway.Proxies.Convencional.EntregablesContrato.Queries
{
    ...
    public class QEContratoConvencionalProxy : IQEContratoConvencionalProxy
    {
        ...
        public QEContratoConvencionalProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.ConvencionalUrl}api/convencional/entregablesContratacion/getEntregablesByContrato/{contrato}");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.ConvencionalUrl}api/convencional/entregablesContratacion/getEntregablesByContratoConvenio/{contrato}/{convenio}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.ConvencionalUrl}api/convencional/entregablesContratacion/getEntregableById/{entregable}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.ConvencionalUrl}api/convencional/entregablesContratacion/visualizarEntregableCont/{contrato}/{tipoEntregable}/{archivo}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.ConvencionalUrl}api/convencional/entregablesContratacion/visualizarEntregableConv/{contrato}/{convenio}/{tipoEntregable}/{archivo}");
            request.EnsureSuccessStatusCode();

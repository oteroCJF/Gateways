...
namespace Api.Gateway.Proxies.Limpieza.Cuestionarios
{
    public interface ILCuestionarioProxy
    {
    ...
    public class LCuestionarioProxy : ILCuestionarioProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public LCuestionarioProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/cuestionarios");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/cuestionarios/{anio}/{mes}/{contrato}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/cuestionarios/getPreguntaById/{pregunta}");
            request.EnsureSuccessStatusCode();

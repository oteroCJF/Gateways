...
namespace Api.Gateway.Proxies.Limpieza.Contratos
{
    ...
    public class LContratoProxy : ILContratoProxy
    {
        ...
        public LContratoProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/contratos");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/contratos/{contrato}");
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> CreateContrato([FromForm] ContratoCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/contratos/createContrato", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> UpdateContrato([FromForm] ContratoUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/contratos/updateContrato", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteContrato([FromForm] ContratoDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/contratos/deleteContrato", content);
            request.EnsureSuccessStatusCode();

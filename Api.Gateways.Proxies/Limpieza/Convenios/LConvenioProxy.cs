...
namespace Api.Gateway.Proxies.Limpieza.Convenios
{
    public interface ILConvenioProxy
    {
    ...
    public class LConvenioProxy : ILConvenioProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public LConvenioProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/convenios/getConveniosByContrato/{contrato}");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/convenios/getConvenioById/{convenio}");
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> CreateConvenio([FromForm] ConvenioCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/convenios/createConvenio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> UpdateConvenio([FromForm] ConvenioUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/convenios/updateConvenio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteConvenio([FromForm] ConvenioDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/convenios/deleteConvenio", content);
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.LimpiezaUrl}api/limpieza/convenios/getRubrosByConvenio/{convenio}");
            request.EnsureSuccessStatusCode();

...
namespace Api.Gateway.Proxies.Fumigacion.Firmantes
{
    ...
    public class FFirmanteProxy : IFFirmanteProxy
    {
        ...
        public FFirmanteProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/firmantes");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/firmantes/getFirmanteById/{firmante}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/firmantes/getFirmantesByInmueble/{inmueble}");
            request.EnsureSuccessStatusCode();
        ...
        public async Task<FirmanteDto> CreateFirmantes([FromBody] FirmanteCreateCommand firmantes)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/firmantes/createFirmantes", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<FirmanteDto> UpdateFirmantes([FromBody] FirmanteUpdateCommand firmantes)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/firmantes/updateFirmantes", content);
            request.EnsureSuccessStatusCode();

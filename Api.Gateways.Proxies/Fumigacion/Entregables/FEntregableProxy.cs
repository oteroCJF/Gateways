...
namespace Api.Gateway.Proxies.Fumigacion.Entregables
{
    ...
    public class FEntregableProxy : IFEntregableProxy
    {
        ...
        public FEntregableProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/entregables");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/entregables/getEntregablesByCedula/{cedula}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/entregables/getEntregableById/{entregable}");
            request.EnsureSuccessStatusCode();
        ...
        public async Task UpdateEntregable([FromForm] EntregableCommandUpdate entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/entregables/actualizarEntregable", formContent);
            request.EnsureSuccessStatusCode();
        }
        ...
        public async Task AUpdateEntregable([FromForm] EEntregableUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/entregables/autorizarEntregable", content);
            request.EnsureSuccessStatusCode();
        }
        ...
        public async Task UpdateEntregableSR([FromBody] ESREntregableUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/entregables/updateEntregableSR", content);
            request.EnsureSuccessStatusCode();
        }

        public async Task<string> VisualizarEntregable(int anio, string mes, string folio, string archivo, string tipo)
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/entregables/visualizarEntregable/{anio}/{mes}/{folio}/{archivo}/{tipo}");
            request.EnsureSuccessStatusCode();

...
namespace Api.Gateway.Proxies.Fumigacion.Oficios
{
    public interface IFOficioProxy
    {
    ...
    public class FOficioProxy : IFOficioProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public FOficioProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/oficios");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/oficios/getOficiosByAnio/{anio}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/oficios/getOficioById/{id}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/oficios/getDetalleOficio/{oficio}");
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> CreateOficio([FromForm] OficioCreateCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/oficios/createOficio", formContent);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<List<DetalleOficioCreateCommand>> CreateDetalleOficio([FromBody] List<DetalleOficioCreateCommand> dtOficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/oficios/createDetalleOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<DetalleOficioDto> DeleteDetalleOficio([FromBody] DetalleOficioDeleteCommand dtOficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/oficios/deleteDetalleOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> CorregirOficio([FromBody] CorregirOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/oficios/corregirOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> EDGPPTOficio([FromBody] EDGPPTOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/oficios/enviarDGPPTOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> PagarOficio([FromBody] PagarOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/oficios/pagarOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> CancelarOficio([FromBody] CancelarOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/oficios/cancelarOficio", content);
            request.EnsureSuccessStatusCode();

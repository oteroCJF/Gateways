...
namespace Api.Gateway.Proxies.Fumigacion.Cuestionarios
{
    public interface IFCuestionarioProxy
    {
    ...
    public class FCuestionarioProxy : IFCuestionarioProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public FCuestionarioProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/cuestionarios");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/cuestionarios/{anio}/{mes}/{contrato}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.FumigacionUrl}api/fumigacion/cuestionarios/getPreguntaById/{pregunta}");
            request.EnsureSuccessStatusCode();

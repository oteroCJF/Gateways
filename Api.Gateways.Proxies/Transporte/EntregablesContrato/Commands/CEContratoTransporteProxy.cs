...
namespace Api.Gateway.Proxies.Transporte.EntregablesContrato.Commands
{
    public interface ICEContratoTransporteProxy
    {
        Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand command);
    }
    public class CEContratoTransporteProxy : ICEContratoTransporteProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public CEContratoTransporteProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.TransporteUrl}api/transporte/entregablesContratacion/updateEntregableContratacion", formContent);

...
namespace Api.Gateway.Proxies.Transporte.CFDIs.Queries
{
    public interface IQCFDITransporteProxy
    {
    ...
    public class QCFDITransporteProxy : IQCFDITransporteProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public QCFDITransporteProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.TransporteUrl}api/transporte/cfdi/getAllFacturas");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.TransporteUrl}api/transporte/cfdi/getFacturasByRepositorio/" + anio);
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.TransporteUrl}api/transporte/cfdi/getFacturasByInmueble/{inmueble}/{facturacion}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.TransporteUrl}api/transporte/cfdi/getConceptosFacturaByIdAsync/{factura}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.TransporteUrl}api/transporte/cfdi/getHistorialMFByRepositorio/{facturacion}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.TransporteUrl}api/transporte/cfdi/getFacturasNCPendientes/{estatus}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.TransporteUrl}api/transporte/cfdi/getFacturasCargadas/{facturacion}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.TransporteUrl}api/transporte/cfdi/getNotasCreditoCargadas/{facturacion}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.TransporteUrl}api/transporte/cfdi/getTotalFacturasByInmueble/{inmueble}/{facturacion}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.TransporteUrl}api/transporte/cfdi/getNCByInmueble/{inmueble}/{facturacion}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.TransporteUrl}api/transporte/cfdi/getFacturacionByCedula/{cedula}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiUrls.TransporteUrl}api/transporte/cfdi/visualizarFactura/{anio}/{mes}/{folio}/{tipo}/{inmueble}/{archivo}");
            request.EnsureSuccessStatusCode();

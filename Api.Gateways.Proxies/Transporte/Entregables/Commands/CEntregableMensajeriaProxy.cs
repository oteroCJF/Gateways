...
namespace Api.Gateway.Proxies.Transporte.Entregables.Commands
{
    public interface ICEntregableTransporteProxy
    {
    ...
    public class CEntregableTransporteProxy : ICEntregableTransporteProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public CEntregableTransporteProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<EntregableDto> CreateEntregable([FromBody] EntregableCreateCommand entregable)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.TransporteUrl}api/transporte/entregables/createEntregable", content);
        ...
        public async Task UpdateEntregable([FromForm] EntregableCommandUpdate entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.TransporteUrl}api/transporte/entregables/actualizarEntregable", formContent);
            request.EnsureSuccessStatusCode();
        }
        ...
        public async Task<EntregableDto> DeleteEntregable([FromBody] EntregableDeleteCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.TransporteUrl}api/transporte/entregables/deleteEntregable", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task AUpdateEntregable([FromForm] EEntregableUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.TransporteUrl}api/transporte/entregables/autorizarEntregable", content);
            request.EnsureSuccessStatusCode();
        }
        ...
        public async Task UpdateEntregableSR([FromBody] ESREntregableUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.TransporteUrl}api/transporte/entregables/updateEntregableSR", content);
            request.EnsureSuccessStatusCode();
        }
    }
}

...
namespace Api.Gateway.WebClient.Proxy.Fumigacion.Oficios
{
    ...
    public class FOficioProxy : IFOficioProxy
    {
        ...
        public FOficioProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<OficioDto>> GetAllOficiosAsync()
        {
            try
            {
                var request = await _httpClient.GetAsync($"{_apiGatewayUrl}fumigacion/oficios");
        ...
        public async Task<List<OficioDto>> GetOficiosByAnio(int anio)
        {
            try
            {
                var request = await _httpClient.GetAsync($"{_apiGatewayUrl}fumigacion/oficios/getOficiosByAnio/{anio}");
                request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> GetOficioById(int id)
        {
            try
            {
                var request = await _httpClient.GetAsync($"{_apiGatewayUrl}fumigacion/oficios/getOficioById/{id}");
                request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}fumigacion/oficios/getFacturasNCPendientes/{oficio}");
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> CreateOficio([FromForm] OficioCreateCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}fumigacion/oficios/createOficio", formContent);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<List<DetalleOficioDto>> CreateDetalleOficio([FromBody] List<DetalleOficioCreateCommand> dtOficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}fumigacion/oficios/createDetalleOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<DetalleOficioDto> DeleteDetalleOficio([FromBody] DetalleOficioDeleteCommand dtOficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}fumigacion/oficios/deleteDetalleOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> CorregirOficio([FromBody] CorregirOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}fumigacion/oficios/corregirOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> PagarOficio([FromBody] PagarOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}fumigacion/oficios/pagarOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> CancelarOficio([FromBody] CancelarOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}fumigacion/oficios/cancelarOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> EDGPPTOficio([FromBody] EDGPPTOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}fumigacion/oficios/eDGPPTOficio", content);
            request.EnsureSuccessStatusCode();

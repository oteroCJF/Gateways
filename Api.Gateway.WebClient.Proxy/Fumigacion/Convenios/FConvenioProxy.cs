...
namespace Api.Gateway.WebClient.Proxy.Fumigacion.Convenios
{
    ...
    public class FConvenioProxy : IFConvenioProxy
    {
        ...
        public FConvenioProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}fumigacion/convenios/getConveniosByContrato/{contrato}");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}fumigacion/convenios/getConvenioById/{convenio}");
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> CreateConvenio([FromForm] ConvenioCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}fumigacion/convenios/createConvenio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> UpdateConvenio([FromForm] ConvenioUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}fumigacion/convenios/updateConvenio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteConvenio([FromForm] ConvenioDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}fumigacion/convenios/deleteConvenio", content);
            request.EnsureSuccessStatusCode();

...
namespace Api.Gateway.WebClient.Proxy.Fumigacion.Incidencias
{
    public interface IFIncidenciaProxy
    {
        ...
        Task CreateIncidencia(FIncidenciaCreateCommand command);
        Task UpdateIncidencia(FIncidenciaUpdateCommand command);
        Task<int> DeleteIncidencias([FromBody] FIncidenciaDeleteCommand incidencia);
        Task<int> DeleteIncidencia([FromBody] FIncidenciaDeleteCommand incidencia);
    ...
    public class FIncidenciaProxy : IFIncidenciaProxy
    {
        ...
        public FIncidenciaProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}fumigacion/incidenciasCedula/getIncidenciasByCedulaAndPregunta/{cedula}/{pregunta}");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}fumigacion/incidenciasCedula/getIncidenciaByCedulaAndPregunta/{cedula}/{pregunta}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}fumigacion/incidenciasCedula/getConfiguracionIncidencias");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}fumigacion/incidenciasCedula/getConfiguracionIncidenciasByPregunta/{pregunta}/{respuesta}");
            request.EnsureSuccessStatusCode();
        ...
        public async Task CreateIncidencia(FIncidenciaCreateCommand incidencia)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}fumigacion/incidenciasCedula/insertaIncidencia", formContent);
            request.EnsureSuccessStatusCode();
        }

        public async Task UpdateIncidencia(FIncidenciaUpdateCommand incidencia)
        {
            var formContent = new MultipartFormDataContent();
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}fumigacion/incidenciasCedula/actualizarIncidencia", formContent);
            request.EnsureSuccessStatusCode();
        }
        ...
        public async Task<int> DeleteIncidencias([FromBody] FIncidenciaDeleteCommand incidencia)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}fumigacion/incidenciasCedula/eliminarIncidencias", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteIncidencia([FromBody] FIncidenciaDeleteCommand incidencia)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}fumigacion/incidenciasCedula/eliminarIncidencia", content);
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}fumigacion/incidenciasCedula/visualizarActas/{anio}/{mes}/{folio}/{tipo}/{tipoArchivo}/{archivo}");
            request.EnsureSuccessStatusCode();

...
namespace Api.Gateway.WebClient.Proxy.Transporte.Convenios.Commands
{
    ...
    public class CConvenioTransporteProxy : ICConvenioTransporteProxy
    {
        ...
        public CConvenioTransporteProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> CreateConvenio([FromForm] ConvenioCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}transporte/convenios/createConvenio", content);
        ...
        public async Task<int> UpdateConvenio([FromForm] ConvenioUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}transporte/convenios/updateConvenio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteConvenio([FromForm] ConvenioDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}transporte/convenios/deleteConvenio", content);
            request.EnsureSuccessStatusCode();

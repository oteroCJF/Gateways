...
namespace Api.Gateway.WebClient.Proxy.Transporte.EntregablesContrato.Commands
{
    ...
    public class CEContratoTransporteProxy : ICEContratoTransporteProxy
    {
        ...
        public CEContratoTransporteProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}transporte/entregablesContrato/updateEntregableContratacion", formContent);

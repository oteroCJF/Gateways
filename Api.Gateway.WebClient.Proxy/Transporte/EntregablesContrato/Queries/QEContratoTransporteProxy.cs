...
namespace Api.Gateway.WebClient.Proxy.Transporte.EntregablesContrato.Queries
{
    ...
    public class QEContratoTransporteProxy : IQEContratoTransporteProxy
    {
        ...
        public QEContratoTransporteProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}transporte/entregablesContrato/getEntregablesByContrato/{contrato}");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}transporte/entregablesContrato/getEntregablesByContratoConvenio/{contrato}/{convenio}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}transporte/entregablesContrato/getEntregableById/{entregable}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}transporte/entregablesContrato/visualizarEntregableCont/{contrato}/{tipoEntregable}/{archivo}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}transporte/entregablesContrato/visualizarEntregableConv/{contrato}/{convenio}/{tipoEntregable}/{archivo}");
            request.EnsureSuccessStatusCode();

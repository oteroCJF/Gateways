...
namespace Api.Gateway.WebClient.Proxy.Limpieza.Convenios
{
    ...
    public class LConvenioProxy : ILConvenioProxy
    {
        ...
        public LConvenioProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}limpieza/convenios/getConveniosByContrato/{contrato}");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}limpieza/convenios/getConvenioById/{convenio}");
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> CreateConvenio([FromForm] ConvenioCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}limpieza/convenios/createConvenio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> UpdateConvenio([FromForm] ConvenioUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}limpieza/convenios/updateConvenio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteConvenio([FromForm] ConvenioDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}limpieza/convenios/deleteConvenio", content);
            request.EnsureSuccessStatusCode();

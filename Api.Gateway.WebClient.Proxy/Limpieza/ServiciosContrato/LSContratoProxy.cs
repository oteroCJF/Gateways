...
namespace Api.Gateway.WebClient.Proxy.Limpieza.ServiciosContrato
{
    ...
    public class LSContratoProxy : ILServicioContratoProxy
    {
        ...
        public LSContratoProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}limpieza/servicioContrato/getServiciosContrato/{contrato}");
        ...
        public async Task<ServicioContratoDto> CreateServicioContrato([FromBody] ServicioContratoCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}limpieza/servicioContrato/createSContrato", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<ServicioContratoDto> UpdateServicioContrato([FromBody] ServicioContratoUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}limpieza/servicioContrato/updateSContrato", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteServicioContrato([FromBody] ServicioContratoDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}limpieza/servicioContrato/deleteSContrato", content);
            request.EnsureSuccessStatusCode();

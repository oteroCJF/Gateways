...
namespace Api.Gateway.WebClient.Proxy.Limpieza.Facturas
{
    ...
    public class LCFDIProxy : ILCFDIProxy
    {
        ...
        public LCFDIProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}limpieza/cfdi/getAllFacturas");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}limpieza/cfdi/getFacturasByFacturacion/{facturacion}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}limpieza/cfdi/getFacturasByInmueble/{inmueble}/{facturacion}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}limpieza/cfdi/getHistorialMFByRepositorio/{facturacion}");
            request.EnsureSuccessStatusCode();
        ...
        public async Task<CFDIDto> CreateFactura([FromForm] CFDICreateCommand factura)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}limpieza/cfdi/createFactura", formContent);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<CFDIDto> UpdateFactura([FromForm] CFDIUpdateCommand factura)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}limpieza/cfdi/updateFactura", formContent);
            request.EnsureSuccessStatusCode();
        ...
        public async Task CreateHistorialMF([FromBody] HistorialMFCreateCommand command)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}limpieza/cfdi/createHistorialMF", content);
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}limpieza/cfdi/visualizarFactura/{anio}/{mes}/{folio}/{tipo}/{inmueble}/{archivo}");
            request.EnsureSuccessStatusCode();

...
namespace Api.Gateway.WebClient.Proxy.Microbiologicos.Convenios.Commands
{
    ...
    public class CConvenioMicrobiologicosProxy : ICConvenioMicrobiologicosProxy
    {
        ...
        public CConvenioMicrobiologicosProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> CreateConvenio([FromForm] ConvenioCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}microbiologicos/convenios/createConvenio", content);
        ...
        public async Task<int> UpdateConvenio([FromForm] ConvenioUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}microbiologicos/convenios/updateConvenio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteConvenio([FromForm] ConvenioDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}microbiologicos/convenios/deleteConvenio", content);
            request.EnsureSuccessStatusCode();

...
namespace Api.Gateway.WebClient.Proxy.Microbiologicos.EntregablesContrato.Commands
{
    ...
    public class CEContratoMicrobiologicosProxy : ICEContratoMicrobiologicosProxy
    {
        ...
        public CEContratoMicrobiologicosProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}microbiologicos/entregablesContrato/updateEntregableContratacion", formContent);

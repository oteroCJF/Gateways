...
namespace Api.Gateway.WebClient.Proxy.Agua.Entregables.Commands
{
    ...
    public class CEntregableAguaProxy : ICEntregableAguaProxy
    {
        ...
        public CEntregableAguaProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task UpdateEntregable(EntregableCommandUpdate entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}agua/entregablesCedula/actualizarEntregable", formContent);
        ...
        public async Task ValidarEntregables(EntregableCommandUpdate entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}agua/entregablesCedula/validarEntregable", formContent);
            request.EnsureSuccessStatusCode();
        }
        ...
        public async Task AUpdateEntregable([FromForm] EEntregableUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}agua/entregablesCedula/AREntregable", formContent);
            request.EnsureSuccessStatusCode();
        }
        ...
        public async Task<string> DescargarEntregables([FromBody] DEntregablesCommand command)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}agua/entregablesCedula/descargarEntregables", content);
            request.EnsureSuccessStatusCode();

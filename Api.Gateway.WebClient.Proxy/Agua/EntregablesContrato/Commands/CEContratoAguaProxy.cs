...
namespace Api.Gateway.WebClient.Proxy.Agua.EntregablesContrato.Commands
{
    public interface ICEContratoAguaProxy
    {
        Task<int> UpdateEntregable(EntregableContratoUpdateCommand entregable);
    }

    public class CEContratoAguaProxy : ICEContratoAguaProxy
    {
        private readonly string _apiGatewayUrl;
        private readonly HttpClient _httpClient;

        public CEContratoAguaProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}agua/entregablesContrato/updateEntregableContratacion", formContent);

...
namespace Api.Gateway.WebClient.Proxy.Agua.ServiciosContrato.Commands
{
    ...
    public class CSContratoAguaProxy : ICSContratoAguaProxy
    {
        ...
        public CSContratoAguaProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<ServicioContratoDto> CreateServicioContrato([FromBody] ServicioContratoCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}agua/servicioContrato/createSContrato", content);
        ...
        public async Task<ServicioContratoDto> UpdateServicioContrato([FromBody] ServicioContratoUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}agua/servicioContrato/updateSContrato", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteServicioContrato([FromBody] ServicioContratoDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}agua/servicioContrato/deleteSContrato", content);
            request.EnsureSuccessStatusCode();

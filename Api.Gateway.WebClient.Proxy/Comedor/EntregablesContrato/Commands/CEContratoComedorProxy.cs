...
namespace Api.Gateway.WebClient.Proxy.Comedor.EntregablesContrato.Commands
{
    ...
    public class CEContratoComedorProxy : ICEContratoComedorProxy
    {
        ...
        public CEContratoComedorProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}comedor/entregablesContrato/updateEntregableContratacion", formContent);

...
namespace Api.Gateway.WebClient.Proxy.Comedor.ServiciosContrato.Commands
{
    ...
    public class CSContratoComedorProxy : ICSContratoComedorProxy
    {
        ...
        public CSContratoComedorProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<ServicioContratoDto> CreateServicioContrato([FromBody] ServicioContratoCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}comedor/servicioContrato/createSContrato", content);
        ...
        public async Task<ServicioContratoDto> UpdateServicioContrato([FromBody] ServicioContratoUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}comedor/servicioContrato/updateSContrato", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteServicioContrato([FromBody] ServicioContratoDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}comedor/servicioContrato/deleteSContrato", content);
            request.EnsureSuccessStatusCode();

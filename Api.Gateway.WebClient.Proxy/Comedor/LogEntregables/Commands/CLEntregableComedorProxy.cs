...
namespace Api.Gateway.WebClient.Proxy.Comedor.LogEntregables.Commands
{
    ...
    public class CLEntregableComedorProxy : ICLEntregableComedorProxy
    {
        ...
        public CLEntregableComedorProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task CreateHistorial(LogEntregableCreateCommand historial)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}comedor/logEntregables/createHistorial", content);

...
namespace Api.Gateway.WebClient.Proxy.Comedor.Convenios.Queries
{
    ...
    public class QConvenioComedorProxy : IQConvenioComedorProxy
    {
        ...
        public QConvenioComedorProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}comedor/convenios/getConveniosByContrato/{contrato}");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}comedor/convenios/getConvenioById/{convenio}");
            request.EnsureSuccessStatusCode();

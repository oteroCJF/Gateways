...
namespace Api.Gateway.WebClient.Proxy.Celular.EntregablesContrato.Commands
{
    ...
    public class CEContratoCelularProxy : ICEContratoCelularProxy
    {
        ...
        public CEContratoCelularProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}celular/entregablesContrato/updateEntregableContratacion", formContent);

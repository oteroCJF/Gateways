...
namespace Api.Gateway.WebClient.Proxy.Convencional.EntregablesContrato.Commands
{
    ...
    public class CEContratoConvencionalProxy : ICEContratoConvencionalProxy
    {
        ...
        public CEContratoConvencionalProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}convencional/entregablesContrato/updateEntregableContratacion", formContent);

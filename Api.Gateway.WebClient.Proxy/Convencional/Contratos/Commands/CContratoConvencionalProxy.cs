...
namespace Api.Gateway.WebClient.Proxy.Convencional.Contratos.Commands
{
    ...
    public class CContratoConvencionalProxy : ICContratoConvencionalProxy
    {
        ...
        public CContratoConvencionalProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> CreateContrato([FromForm] ContratoCreateCommand contrato)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}convencional/contratos/createContrato", content);
        ...
        public async Task<int> UpdateContrato([FromForm] ContratoUpdateCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}convencional/contratos/updateContrato", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<int> DeleteContrato([FromForm] ContratoDeleteCommand contrato)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}convencional/contratos/deleteContrato", content);
            request.EnsureSuccessStatusCode();

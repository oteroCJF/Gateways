...
namespace Api.Gateway.WebClient.Proxy.Mensajeria.Oficios.Commands
{
    ...
    public class COficioMensajeriaProxy : ICOficioMensajeriaProxy
    {
        ...
        public COficioMensajeriaProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<OficioDto> CreateOficio([FromForm] OficioCreateCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}mensajeria/oficios/createOficio", formContent);
        ...
        public async Task<List<DetalleOficioDto>> CreateDetalleOficio([FromBody] List<DetalleOficioCreateCommand> dtOficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}mensajeria/oficios/createDetalleOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<DetalleOficioDto> DeleteDetalleOficio([FromBody] DetalleOficioDeleteCommand dtOficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}mensajeria/oficios/deleteDetalleOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> CorregirOficio([FromBody] CorregirOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}mensajeria/oficios/corregirOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> PagarOficio([FromBody] PagarOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}mensajeria/oficios/pagarOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> CancelarOficio([FromBody] CancelarOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}mensajeria/oficios/cancelarOficio", content);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<OficioDto> EDGPPTOficio([FromBody] EDGPPTOficioCommand oficio)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}mensajeria/oficios/eDGPPTOficio", content);
            request.EnsureSuccessStatusCode();

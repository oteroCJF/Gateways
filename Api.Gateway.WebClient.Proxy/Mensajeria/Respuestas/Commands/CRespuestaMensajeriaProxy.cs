...
namespace Api.Gateway.WebClient.Proxy.Mensajeria.Respuestas.Commands
{
    ...
    public class CRespuestaMensajeriaProxy : ICRespuestaMensajeriaProxy
    {
        ...
        public CRespuestaMensajeriaProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task UpdateRespuestas(List<RespuestasUpdateCommand> respuestas)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}mensajeria/respuestas/updateRespuestasByCedula", content);

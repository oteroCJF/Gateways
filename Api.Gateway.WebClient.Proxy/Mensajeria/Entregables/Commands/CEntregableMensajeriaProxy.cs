...
namespace Api.Gateway.WebClient.Proxy.Mensajeria.Entregables.Commands
{
    ...
    public class CEntregableMensajeriaProxy : ICEntregableMensajeriaProxy
    {
        ...
        public CEntregableMensajeriaProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task UpdateEntregable(EntregableCommandUpdate entregable)
        {
            ...
            if (entregable.Archivo != null)
            {
                ...
                formContent.Add(new StringContent(entregable.Supervicion.ToString()), "Supervicion");
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}mensajeria/entregablesCedula/actualizarEntregable", formContent);
        ...
        public async Task ValidarEntregables(EntregableCommandUpdate entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}mensajeria/entregablesCedula/validarEntregable", formContent);
            request.EnsureSuccessStatusCode();
        }
        ...
        public async Task AUpdateEntregable([FromForm] EEntregableUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}mensajeria/entregablesCedula/AREntregable", formContent);
            request.EnsureSuccessStatusCode();
        }
        ...
        public async Task<string> DescargarEntregables([FromBody] DEntregablesCommand command)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}mensajeria/entregablesCedula/descargarEntregables", content);
            request.EnsureSuccessStatusCode();

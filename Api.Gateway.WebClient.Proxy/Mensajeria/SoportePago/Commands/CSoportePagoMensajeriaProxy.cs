...
namespace Api.Gateway.WebClient.Proxy.Mensajeria.SoportePago.Commands
{
    ...
    public class CSoportePagoMensajeriaProxy : ICSoportePagoMensajeriaProxy
    {
        ...
        public CSoportePagoMensajeriaProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {

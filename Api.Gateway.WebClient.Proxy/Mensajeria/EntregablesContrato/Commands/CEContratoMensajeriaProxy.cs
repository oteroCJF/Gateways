...
namespace Api.Gateway.WebClient.Proxy.Mensajeria.EntregablesContrato.Commands
{
    ...
    public class CEContratoMensajeriaProxy : ICEContratoMensajeriaProxy
    {
        ...
        public CEContratoMensajeriaProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<int> UpdateEntregable([FromForm] EntregableContratoUpdateCommand entregable)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}mensajeria/entregablesContrato/updateEntregableContratacion", formContent);

...
namespace Api.Gateway.Models.CedulasEvaluacion.ServiciosGenerales.DTOs.Comedor
{
    public class CedulaComedorDto
    {
        ...
        public CTServicioContratoDto Servicio { get; set; } = new CTServicioContratoDto();
        ...
        public List<CuestionarioComedorDto> Cuestionario { get; set; } = new List<CuestionarioComedorDto>();
